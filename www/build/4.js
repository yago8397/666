...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_storage_service__ = __webpack_require__(350);
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, toasCtrl, firebaseauth, storageService) {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"c:\so-gela\src\pages\home\home.html"*/'<ion-header>\n\n</ion-header>\n\n<ion-content padding >\n  <img src="https://png.pngtree.com/element_origin_min_pic/16/09/27/1057e9de1c951de.jpg" alt="">\n\n  <h3>Bem-vindo!</h3>\n\n  <ion-list>\n    <ion-item>\n      <ion-label stacked>Username</ion-label>\n      <ion-input type="text" #usuario></ion-input>\n    </ion-item>\n    <ion-item>\n\n      <ion-label stacked>Password</ion-label>\n      <ion-input type="password" #senha></ion-input>\n    </ion-item>\n  </ion-list>\n\n  <button ion-button block (click)="login()">ENTRAR</button>\n  <button ion-button block outline (click)="cadastro()">REGISTRAR</button>\n\n</ion-content>\n'/*ion-inline-end:"c:\so-gela\src\pages\home\home.html"*/
        }),
